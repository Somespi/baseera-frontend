...
class VQA {
  ...
  Future<String?> caption(dynamic image) async {
    const prompt =
        "Describe this scene for a blind with as short description as possible, limit is 60 words IN ARABIC unless the description is too short and DO NOT say anything else.";
    final content = [
      Content.multi([
        TextPart(prompt),
        DataPart('image/jpeg', JpegEncoder().encode(image)),
